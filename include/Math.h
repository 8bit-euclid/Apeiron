...
{
  return Zero <= _value && _value < Infinity ? Detail::SqrtNewtonRaphson(_value, _value, Zero) : QuietNaN;
}

constexpr Float
Cbrt(const Float& _value)
{
  return Detail::CbrtNewtonRaphson(_value, One, Zero);
}
...
Exp(Float _value)
{
  return Detail::Exp(_value, 1.0, 1.0, 2, _value);
}
