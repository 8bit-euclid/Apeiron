...
#include "Visualiser/include/ObjectFactory.h"
...
//
//   // Triangle
//   model = ObjectFactory::Triangle(1.0, false);
...
//   model = ObjectFactory::Square(10.0, false);
//   model.SetName("Floor")
...
//
//   // Wall 0
//   model = ObjectFactory::Square(5.0, false);
...
//   scene.Add(model);
   ...
   // Floor
   const Real height_scale = 0.08;
   object = ObjectFactory::Square(10.0);
   ...
   // Wall 0
   object = ObjectFactory::Square(5.0);
   object->SetName("Wall 0")
         ->SetMaterial("Brick", 0.8, 256.0)
         ->SetTexture("Brick", "Wall", 1, 2, height_scale)
         ->OffsetPosition({2.5f, 0.5f, -5.0f});
   scene.Add(object);
