...
constexpr StaticArray<Float, 2>
Ellipse(const StaticArray<Float, 2>& _radii, const Float _theta)
{
  return { _radii[0]*Cos(_theta), _radii[1]*Sin(_theta) };
}

constexpr StaticArray<Float, 3>
...
constexpr StaticArray<Float, 3>
Ellipsoid(const StaticArray<Float, 3>& _radii, const Float _theta, const Float _phi)
{
