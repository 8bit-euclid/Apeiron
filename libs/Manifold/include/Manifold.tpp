...
Manifold<derived, manifold_dim, ambient_dim>::Point(const std::convertible_to<Real> auto... _params)
{
...
template<class derived, size_t manifold_dim, size_t ambient_dim>
constexpr SVectorR<ambient_dim>
Manifold<derived, manifold_dim, ambient_dim>::Tangent(const std::convertible_to<Real> auto... _params)
{
   ParamCountCheck(_params...);
...
template<class derived, size_t manifold_dim, size_t ambient_dim>
constexpr SVectorR<ambient_dim>
Manifold<derived, manifold_dim, ambient_dim>::Bitangent(const std::convertible_to<Real> auto... _params)
{
   ParamCountCheck(_params...);
...
template<class derived, size_t manifold_dim, size_t ambient_dim>
constexpr SVectorR<ambient_dim>
Manifold<derived, manifold_dim, ambient_dim>::Normal(const std::convertible_to<Real> auto... _params)
{
   ParamCountCheck(_params...);
...
template<class derived, size_t manifold_dim, size_t ambient_dim>
constexpr void
Manifold<derived, manifold_dim, ambient_dim>::ParamCountCheck(const std::convertible_to<Real> auto... _params) const
{
