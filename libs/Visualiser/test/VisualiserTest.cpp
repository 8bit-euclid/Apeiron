...
VisualiserTest::VisualiserTest()
  : TextureTest(TextureType::Diffuse, false)
{
...
{
   ModelTest = ModelFactory::Square(100.0f);
...
//  glm::mat4 view_matrix = glm::translate(glm::mat4(1.0f), glm::vec3(0, 0, 0));
   ...
   ShaderTest.Read("libs/Visualiser/resources/shaders/Basic.glsl");
   ShaderTest.Bind();

   ShaderTest.SetUniform4f("u_color", 0.8f, 0.3f, 0.8f, 1.0f);

   TextureTest.Read("libs/Visualiser/resources/textures/ChernoLogo.png", GL_CLAMP_TO_EDGE);
   TextureTest.Bind();
